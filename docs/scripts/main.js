const WINDOWHOP_SITE = Object.freeze({
  ...
  releaseNotes: "https://github.com/martonpaulo/windowhop/releases/tag/v1.3.1",
  download: "https://github.com/martonpaulo/windowhop/releases/latest/download/WindowHop-1.3.1-Installer.zip",
