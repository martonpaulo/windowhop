...
| Credit in Settings › About | The © line only, with the AltTab credit as text and no link to the AltTab repository; no separate header credit | [AGENTS.md](../AGENTS.md), "Copyright" | [#123](https://github.com/martonpaulo/windowhop/issues/123), [#132](https://github.com/martonpaulo/windowhop/issues/132) |
