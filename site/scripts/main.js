const WINDOWHOP_SITE = Object.freeze({
  ...
  releaseNotes: "https://github.com/martonpaulo/windowhop/releases/tag/v1.6.2",
  download: "https://github.com/martonpaulo/windowhop/releases/latest/download/WindowHop-1.6.2-Installer.zip",
