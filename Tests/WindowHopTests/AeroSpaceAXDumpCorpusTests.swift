...
final class AeroSpaceAXDumpCorpusTests: XCTestCase {
    ...
    static func decide(_ dump: Dump) -> Decision {
        ...
        let state = WindowDisplayState(
            isMinimized: dump.isMinimized, isAppHidden: false,
    ...
    private static func dump(from file: URL) throws -> Dump {
        ...
        return Dump(
            ...
            buttons: .init(
                close: enabled("AXCloseButton"), minimize: enabled("AXMinimizeButton"),
