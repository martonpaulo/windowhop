...
final class LaunchPresentationTests: XCTestCase {
    ...
    private let rows: [Row] = [
        ...
        Row(name: "first run, icons hidden", trigger: .normalLaunch, granted: true,
            firstRun: true, menuBarItem: false, dockIcon: false, expected: .settings),
        Row(name: "first run, menu bar item shown", trigger: .normalLaunch, granted: true,
            firstRun: true, menuBarItem: true, dockIcon: false, expected: .settings),
        Row(name: "later run, menu bar item shown", trigger: .normalLaunch, granted: true,
            firstRun: false, menuBarItem: true, dockIcon: false, expected: .none),
        Row(name: "later run, Dock icon shown", trigger: .normalLaunch, granted: true,
            firstRun: false, menuBarItem: false, dockIcon: true, expected: .none),
        Row(name: "later run, both shown", trigger: .normalLaunch, granted: true,
            firstRun: false, menuBarItem: true, dockIcon: true, expected: .none),
        Row(name: "later run, both hidden", trigger: .normalLaunch, granted: true,
            firstRun: false, menuBarItem: false, dockIcon: false, expected: .settings),
        // login-item launch, granted: silent whatever is visible
        Row(name: "login, both hidden", trigger: .loginItemLaunch, granted: true,
            firstRun: false, menuBarItem: false, dockIcon: false, expected: .none),
        Row(name: "login, menu bar item shown", trigger: .loginItemLaunch, granted: true,
            firstRun: false, menuBarItem: true, dockIcon: false, expected: .none),
        Row(name: "login, first run", trigger: .loginItemLaunch, granted: true,
        ...
        Row(name: "normal, not granted, icon shown", trigger: .normalLaunch, granted: false,
            firstRun: false, menuBarItem: true, dockIcon: true, expected: .onboarding),
        Row(name: "normal, not granted, first run", trigger: .normalLaunch, granted: false,
            firstRun: true, menuBarItem: false, dockIcon: false, expected: .onboarding),
        Row(name: "login, not granted", trigger: .loginItemLaunch, granted: false,
            firstRun: false, menuBarItem: false, dockIcon: false, expected: .onboarding),
        Row(name: "login, not granted, icon shown", trigger: .loginItemLaunch, granted: false,
        ...
        Row(name: "reopen, granted, icons shown", trigger: .reopen, granted: true,
            firstRun: false, menuBarItem: true, dockIcon: true, expected: .settings),
        Row(name: "reopen, granted, icons hidden", trigger: .reopen, granted: true,
            firstRun: false, menuBarItem: false, dockIcon: false, expected: .settings),
        Row(name: "reopen, not granted", trigger: .reopen, granted: false,
            firstRun: false, menuBarItem: true, dockIcon: false, expected: .onboarding),
    ]
